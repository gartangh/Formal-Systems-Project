...
VARIABLES
	...
	(* Mutexes *)
        busyA, busyB, busyC, busyD, busyF, busyG, busyH, busyP1, busyP2, busyP3, busyP4
...
TrainLeavesP1W ==   /\ L1W!IsGreen \/ L1W!IsYellow
                    /\ C!TrainEnters(targetPlatformP1, targetDestinationP1))
                    /\ P1!TrainLeaves
                    /\ L1W!SetRed

TrainLeavesP2W ==	/\ L2W!IsGreen \/ L2W!IsYellow
                    /\ C!TrainEnters(targetPlatformP2, targetDestinationP2))
                    /\ P2!TrainLeaves
                    /\ L2W!SetRed

TrainLeavesP3W ==	/\ L3W!IsGreen \/ L3W!IsYellow
                    /\ C!TrainEnters(targetPlatformP3, targetDestinationP3))
                    /\ P3!TrainLeaves
                    /\ L3W!SetRed
                    
TrainLeavesP4W ==	/\ L4W!IsGreen \/ L4W!IsYellow
                    /\ C!TrainEnters(targetPlatformP4, targetDestinationP4))
                    /\ P4!TrainLeaves
                    /\ L4W!SetRed
...
SetPathP1toD == /\ busyA = 0 /\ busyB = 0 /\ busyC = 0 /\ busyD = 0
                ...
                /\ SA1!SwitchSecond /\ SB2!SWitchSecond /\ SC2!SwitchFirst /\ SD2!SwitchSecond
                /\ L1E!SetGreen
